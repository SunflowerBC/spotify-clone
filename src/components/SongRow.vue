...
<template>
  <li
    class="flex items-center justify-between rounded-md hover:bg-teal-300"
  ...
  >
    <div class="flex items-center w-full py-1.5">
      ...
      <div>
        ...
        <div class="text-teal-500 text-sm font-semibold">{{ artist.name }}</div>
      </div>
    </div>
    <div class="flex items-center">
      <button type="button" v-if="isHover">
        <Heart fillColor="#DB7093" :size="22" />
      </button>
